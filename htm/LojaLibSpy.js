...
function ShowCartOnPage(IDLoja,iErr,sMsg,sCartText,sCheckoutText,este){
  ...
  oDivShowCartOnPage.style.marginTop="-50px";
  ...
  var sHTML="<table id=idTabShowCartOnPageFC width=185 height=100 cellpadding=3 cellspacing=3>";
     ...
     if(iErr==0){
       sHTML+="<tr height=50>";
       sHTML+="<td width=3>&nbsp;</td>";
       sHTML+="<td align=center style=cursor:pointer onclick=window.top.location.href='addproduto.asp?idloja="+ IDLoja +"'><a href='#na' onclick=window.top.location.href='addproduto.asp?idloja="+ IDLoja +"' style=color:#444444;text-decoration:none;font-size:11px;>"+ sCartText +"</a></td>";
       sHTML+="<td width=3>&nbsp;</td>";
       sHTML+="<td align=center style=cursor:pointer onclick=window.top.location.href='addproduto.asp?idloja="+ IDLoja +"'><a href='#na' onclick=window.top.location.href='addproduto.asp?idloja="+ IDLoja +"' style=color:#444444;text-decoration:none;font-size:11px;>"+ sCheckoutText +"</a></td>";
       ...
       sHTML+="</tr>";
//       AtualizaCarrinhoSpy(); //Atualiza carrinho no topo da loja
     }
     else{
       sHTML+="<tr height=20>";
