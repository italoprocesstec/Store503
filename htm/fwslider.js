...
(function($) {
	...
	$.fn.fwslider = function(options){
		...
		this.each(function() {
			...
			if(options.nav) {
				obj.append('<div id="fw-nav-box"><div id="fw-nav-next"><a href="javascript:void(0);">next</a></div><div id="fw-nav-prev"><a href="javascript:void(0);">prev</a></div></div>');
			...
			function adjust(){
				for(i=n;i<options.panels;i++) {
					$("p", obj).slice(i-n,i-n+1).clone().appendTo(obj);
				}
			};
			...
			function animate(dir,clicked){
				if(!animating) {
					...
					switch(dir){
						case "next":
							var begin = $('#fw-slider p', obj).first();
